// THIS IS SIMPLY-DJS'S RPS CODE (lol)
"use strict";
...
const resolveButtonStyle = (style) => typeof style === 'string' ? buttonStyles[style] : style;
// ------------------------------
// ------ F U N C T I O N -------
// ------------------------------
/**
...
function rps(message, options = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
            ...
            options.drawColor = options.drawColor || `#ffb8bf`;
            options.winColor = options.winColor || `#ffb8bf`;
            const rock = new discord_js_1.ButtonBuilder()
                ...
                .setCustomId('rock')
                .setStyle(resolveButtonStyle((_x = (_w = options.buttons) === null || _w === void 0 ? void 0 : _w.rock) === null || _x === void 0 ? void 0 : _x.style))
            ...
            const paper = new discord_js_1.ButtonBuilder()
                ...
                .setCustomId('paper')
                .setStyle(resolveButtonStyle((_3 = (_2 = options.buttons) === null || _2 === void 0 ? void 0 : _2.paper) === null || _3 === void 0 ? void 0 : _3.style))
            ...
            const scissors = new discord_js_1.ButtonBuilder()
                ...
                .setStyle(resolveButtonStyle((_9 = (_8 = options.buttons) === null || _8 === void 0 ? void 0 : _8.scissor) === null || _9 === void 0 ? void 0 : _9.style))
            ...
            try {
                ...
                if (!interaction) {
                    if (!opponent) {
                        yield mes.reply({content: 'No opponent mentioned!', allowedMentions: { repliedUser: false }});
                        resolve();
                        return;
                    }
                    if (opponent.bot) {
                        yield mes.reply({content: 'You cannot play against bots!', allowedMentions: { repliedUser: false }});
                        resolve();
                        return;
                    }
                    if (opponent.id === message.member.user.id) {
                        yield mes.reply({content: 'You cannot play by yourself!', allowedMentions: { repliedUser: false }});
                        resolve();
                        return;
                    }
                }
                ...
                const acceptEmbed = new discord_js_1.EmbedBuilder()
                    ...
                    .setDescription(`Rock Paper Scissor request for ${message.mentions.users.first()}!`)
                    .setAuthor({
                ...
                if (interaction) {
                    m = yield int.followUp({
                        content: `Hey **${opponent.tag}**. You got a RPS invitation !`,
                        embeds: [acceptEmbed],
